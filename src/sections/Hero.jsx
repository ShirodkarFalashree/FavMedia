...
const Hero = () => {
  return (
    <div className="bg-black text-white md:min-h-screen flex flex-col justify-center items-center py-10 md:py-0 gap-0 md:gap-2 px-4 sm:px-6 lg:px-8 md:mt-[-60px] mb-10">
      {/* Animated tagline */}
