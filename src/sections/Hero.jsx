...
const Hero = () => {
  return (
    <div className="bg-black text-white md:min-h-screen flex flex-col justify-center items-center">
      <div className="p-[1px] rounded-full bg-gradient-to-r from-white to-black">
        <div className="flex items-center justify-center bg-white dark:bg-black p-2 rounded-full">
          <span className="">
            <GoDotFill />{" "}
          </span>
